...
**Что куда пишется.** Находки о поведении системы — `.claude/rules/design-system-findings.md`.
Договорённости с дизайнером — `.claude/rules/decisions.md`. Ход работы не пишется никуда.
